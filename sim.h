...
extern uint64_t store_load_forwarding_count_thread[HW_MAX_THREAD] ;
extern uint64_t dram_row_buffer_hit_count_thread[HW_MAX_THREAD];
extern uint64_t dram_row_buffer_miss_count_thread[HW_MAX_THREAD];
